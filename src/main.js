import './style.css';
const PROFILE = {"day":"Day009","title":"Signal Card Mixer","one_sentence":"カードの組み合わせから次の試作案を素早く作るデッキ型ツール。（話題:HN Frontpage）","core_action":"recombine","family":"idea_cards","mechanic":"random_recombination","input_style":"multi_select_tokens","output_style":"card_stack","audience_promise":"faster_idea_divergence","publish_hook":"デッキを引くだけで試作テーマが決まる","engine":"card_mixer","interaction_archetype":"card_deck_recombination","page_archetype":"deck_stage","output_shape":"stacked_cards","state_model":"deck_history_with_lock","core_loop":"draw -> lock -> redraw","component_pack":"deck_controls+history_panel","scaffold_id":"card_deck_board","single_shot_text_generator":false};

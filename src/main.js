import './style.css';
const PROFILE = {"day":"Day009","title":"Analogy Spark Lab","one_sentence":"難しい話題を比喩で伝えやすくする発想支援ツール。（話題:HN Frontpage）","core_action":"analogize","family":"analogy_generator","mechanic":"metaphor_mapping","input_style":"concept_phrase","output_style":"analogy_set","audience_promise":"better_explanations","publish_hook":"説明しづらい概念を比喩で翻訳","engine":"copy_angle"};
